 ...
 *     state_ownership: ['currentView', 'workflowState', 'integrationTask']
-->

<script lang="ts">
    import { onMount } from 'svelte';
    import type { ExtensionMessage, WorkflowViewState, TaskReadyForIntegrationMessage } from '../../packages/client/src/shared/types';
    ...
    // Possible views
    type View = 'Lobby' | 'MissionControl' | 'Integration';
