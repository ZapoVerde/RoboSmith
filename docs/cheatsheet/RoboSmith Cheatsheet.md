...
| Command | Description |
|---|---|
| pnpm dev:slicer | This is a convenient script that runs both the UI and the watcher for the context slicer in parallel using run-p, which is a part of the npm-run-all package. |
